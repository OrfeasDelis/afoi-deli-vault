...
| R5 | n8n hosting — self-hosted or cloud? | Moot — n8n abandoned; settled on the Python worker + Supabase Postgres, no external workflow tool | 2026-06-14 |
| R6 | Postgres hosting — local, Supabase, or managed? | Supabase (Postgres) | 2026-06-14 |
